...
{
    [Keyless]
    public partial class DboVwcHugo
    {
        [Column("CodOS")]
        ...
        [Column("DataHoraSolucaoRAT", TypeName = "datetime")]
        public DateTime? DataHoraSolucaoRat { get; set; }
        [Column("NomeEquipSNS")]
        [StringLength(50)]
        ...
        [Column("RATCodTecnico")]
        public int? RatcodTecnico { get; set; }
        [StringLength(24)]
        public string CodMagnusPeca { get; set; }
        [StringLength(80)]
        public string NomeDaPeca { get; set; }
        public int? CodPeca { get; set; }
        [StringLength(50)]
        public string NomeDoTecnico { get; set; }
        [Column("StatusAtendimentoRAT")]
        [StringLength(50)]
        public string StatusAtendimentoRat { get; set; }
