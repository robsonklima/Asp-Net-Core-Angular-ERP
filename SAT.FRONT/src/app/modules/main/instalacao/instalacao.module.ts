...
import { InstalacaoListaAberturaChamadosComponent } from './instalacao-lista/instalacao-lista-abertura-chamados/instalacao-lista-abertura-chamados.component';
...
@NgModule({
  declarations: [
    ...
    InstalacaoListaAberturaChamadosComponent,
  ],
  imports: [
    CommonModule,
