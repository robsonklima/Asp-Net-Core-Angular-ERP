...
import { OrcamentoParameters, OrcamentoData, Orcamento, OrcamentosFaturamentoParameters } from '../types/orcamento.types';
...
export class OrcamentoService
{
    ...
    obterPorParametros(parameters: OrcamentosFaturamentoParameters): Observable<OrcamentoData>
    {
