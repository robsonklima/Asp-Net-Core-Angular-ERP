...
{
    [Keyless]
    public partial class VwRelatorioVandalismo
    {
        [Column("CodOS")]
        ...
        [Required]
        [Column("COFRE_FECHADURA")]
        [StringLength(3)]
        public string CofreFechadura { get; set; }
        [Column("CAUSA_COFRE_FECHADURA")]
        [StringLength(76)]
        public string CausaCofreFechadura { get; set; }
        [Required]
        [Column("VANDALISMO")]
        [StringLength(3)]
        public string Vandalismo { get; set; }
        [Column("CAUSA_VANDALISMO")]
        [StringLength(76)]
        public string CausaVandalismo { get; set; }
    }
}
