...
@Component({
	selector: 'app-filial-filtro',
	templateUrl: './filial-filtro.component.html'
})
export class FilialFiltroComponent extends FilterBase implements OnInit, IFilterBase {
	...
	constructor(
		...
		super(_userService, _formBuilder, 'filial');
	}
