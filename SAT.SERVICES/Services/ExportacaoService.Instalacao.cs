        ...
        protected void GerarPlanilhaInstalacao(InstalacaoParameters parameters)
        {
            ...
            var sheet = viewUnificada.Select(v =>
                            new
                            {
                                ...
                                DataRemessa = v.DataRemessa.HasValue ? v.DataRemessa.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                PrevisaoEntrega = v.PrevisaoEntrega.HasValue ? v.PrevisaoEntrega.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DtConfirmadaEntrega = v.DtConfirmadaEntrega.HasValue ? v.DtConfirmadaEntrega.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                NFRemessa = v.NFRemessa ?? Constants.NENHUM_REGISTRO,
                                NFRemessaDataExpedicao = v.NFRemessaDataExpedicao.HasValue ? v.NFRemessaDataExpedicao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DtExpedicao = v.DtExpedicao.HasValue ? v.DtExpedicao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                RecebimentoDocumentacaoInstalacao = v.RecebimentoDocumentacaoInstalacao.HasValue ? v.RecebimentoDocumentacaoInstalacao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                FaturaTranspReEntrega = v.FaturaTranspReEntrega ?? Constants.NENHUM_REGISTRO,
                                DtReEntrega = v.DtReEntrega.HasValue ? v.DtReEntrega.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ResponsavelRecebReEntrega = v.ResponsavelRecebReEntrega ?? Constants.NENHUM_REGISTRO,
                                DataEntregaConfirmacao = v.DataEntregaConfirmacao.HasValue ? v.DataEntregaConfirmacao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                PrevisaoInstalacao = v.PrevisaoInstalacao.HasValue ? v.PrevisaoInstalacao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DtAgendadaInstalacao = v.DtAgendadaInstalacao.HasValue ? v.DtAgendadaInstalacao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                OS = v.OS.HasValue ? v.OS.Value.ToString() : Constants.NENHUM_REGISTRO,
                                DataHoraOS = v.DataHoraOS.HasValue ? v.DataHoraOS.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DtInstalacao = v.DtInstalacao.HasValue ? v.DtInstalacao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DataNFTradeIn1 = v.DataNFTradeIn1.HasValue ? v.DataNFTradeIn1.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DataNFTradeIn2 = v.DataNFTradeIn2.HasValue ? v.DataNFTradeIn2.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DtPrevRecolhimentoTradeIn = v.DtPrevRecolhimentoTradeIn.HasValue ? v.DtPrevRecolhimentoTradeIn.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DataRetiradaBemTradeIn = v.DataRetiradaBemTradeIn.HasValue ? v.DataRetiradaBemTradeIn.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                Romaneio = v.Romaneio ?? Constants.NENHUM_REGISTRO,
                                NFTranspTradeIn = v.NFTranspTradeIn ?? Constants.NENHUM_REGISTRO,
                                DataNFTransTradeIn = v.DataNFTransTradeIn.HasValue ? v.DataNFTransTradeIn.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DtNFVendaTradeIn = v.DtNFVendaTradeIn.HasValue ? v.DtNFVendaTradeIn.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DtNFInstalacaoAutorizada = v.DtNFInstalacaoAutorizada.HasValue ? v.DtNFInstalacaoAutorizada.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                NFVenda = v.NFVenda.HasValue ? v.NFVenda.Value.ToString() : Constants.NENHUM_REGISTRO,
                                NFVendaDataEmissao = v.NFVendaDataEmissao.HasValue ? v.NFVendaDataEmissao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DtEnvioNFVenda = v.DtEnvioNFVenda.HasValue ? v.DtEnvioNFVenda.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DtRecebimentoNFVenda = v.DtRecebimentoNFVenda.HasValue ? v.DtRecebimentoNFVenda.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DtPagtoEntrega = v.DtPagtoEntrega.HasValue ? v.DtPagtoEntrega.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                VlrPagtoEntrega = string.Format("{0:C}", v.VlrPagtoEntrega),                              
                                DtPagtoInstalacao = v.DtPagtoInstalacao.HasValue ? v.DtPagtoInstalacao.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DTVencimentoBordero100Perc = v.DTVencimentoBordero100Perc.HasValue ? v.DTVencimentoBordero100Perc.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DTEntregaBordero100Perc = v.DTEntregaBordero100Perc.HasValue ? v.DTEntregaBordero100Perc.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DTVencimentoBordero90Perc = v.DTVencimentoBordero90Perc.HasValue ? v.DTVencimentoBordero90Perc.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DTEntregaBordero90Perc = v.DTEntregaBordero90Perc.HasValue ? v.DTEntregaBordero90Perc.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DTVencimentoBordero10Perc = v.DTVencimentoBordero10Perc.HasValue ? v.DTVencimentoBordero10Perc.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                DTEntregaBordero10Perc = v.DTEntregaBordero10Perc.HasValue ? v.DTEntregaBordero10Perc.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DataFaturaFrete1 = v.DataFaturaFrete1.HasValue ? v.DataFaturaFrete1.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
                                ...
                                DataFaturaFrete2 = v.DataFaturaFrete2.HasValue ? v.DataFaturaFrete1.Value.ToString("dd/MM/yy") : Constants.NENHUM_REGISTRO,
