...
namespace SAT.MVC.Model
{
    [Keyless]
    [Table("TudoPerto")]
    public partial class TudoPerto
    {
        [StringLength(255)]
        ...
        [Column("CPF/CNPJ Conveniado")]
        [StringLength(255)]
        public string CpfCnpjConveniado { get; set; }
        [StringLength(255)]
        ...
        [Column("Data Desabilitação", TypeName = "datetime")]
        public DateTime? DataDesabilitação { get; set; }
        [StringLength(255)]
