...
@Component({
	selector: 'app-instalacao-contrato-filtro',
	templateUrl: './instalacao-contrato-filtro.component.html',
})
export class InstalacaoContratoFiltroComponent extends FilterBase implements OnInit, IFilterBase {
