    ...
    public void Deletar(int codOrc)
        ...
        public Orcamento ObterPorCodigo(int codigo)
        {
            return _context.Orcamento
                .Include(o => o.Filial!.Cidade)
                .Include(o => o.Filial!.OrcamentoISS)
                .Include(o => o.Cliente)
                .Include(o => o.OrdemServico.StatusServico)
                .Include(o => o.OrdemServico.TipoIntervencao)
                .Include(o => o.OrdemServico.Autorizada)
                .Include(o => o.OrdemServico.Regiao)
                .Include(o => o.OrdemServico.Cliente)
                .Include(o => o.OrdemServico.LocalAtendimento.Cidade.UnidadeFederativa)
                .Include(o => o.OrdemServico.EquipamentoContrato.Equipamento)
                .Include(o => o.OrdemServico.EquipamentoContrato.Contrato)
                .Include(o => o.OrdemServico.RelatoriosAtendimento)
                        .ThenInclude(s => s.Laudos)
                            .ThenInclude(s => s.LaudoStatus)
                .Include(o => o.OrdemServico.RelatoriosAtendimento)
                        .ThenInclude(s => s.Laudos)
                            .ThenInclude(s => s.LaudosSituacao)
                .Include(p => p.LocalEnvioNFFaturamentoVinculado.LocalEnvioNFFaturamento.CidadeEnvioNF)
                .Include(p => p.OrcamentoMotivo)
                .Include(p => p.Materiais)
        ...
        public PagedList<Orcamento> ObterPorParametros(OrcamentoParameters parameters)
        {
            var query = _context.Orcamento
                ...
                .Include(o => o.OrdemServico.Autorizada)
                .Include(o => o.OrdemServico.Regiao)
                .Include(o => o.OrdemServico.LocalAtendimento)
                .Include(o => o.OrdemServico.EquipamentoContrato.Equipamento)
                .Include(o => o.OrdemServico.RelatoriosAtendimento)
                    .ThenInclude(s => s.Laudos)
                            .ThenInclude(s => s.LaudosSituacao)
                .Include(o => o.OrdemServico)
                    .ThenInclude(s => s.RelatoriosAtendimento)
                        .ThenInclude(s => s.Laudos)
                            .ThenInclude(s => s.LaudoStatus)
                .Include(p => p.LocalEnvioNFFaturamentoVinculado.LocalEnvioNFFaturamento)
