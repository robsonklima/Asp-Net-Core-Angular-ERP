        ...
        protected void GerarPlanilhaOrdemServico(OrdemServicoParameters parameters)
        {
            ...
            var exportUnificado = viewUnificada.Select(v =>
                                            new
                                            {
                                                ...
                                                DataHoraIntegracao = v.DataHoraIntegracao.HasValue ? v.DataHoraIntegracao.Value.ToString("dd/MM/yy HH:mm") : Constants.NENHUM_REGISTRO,
                                                ...
                                                DataFimGarantia = v.DataFimGarantia.HasValue ? v.DataFimGarantia.Value.ToString("dd/MM/yy HH:mm") : Constants.NENHUM_REGISTRO,
