...
@Component({
  selector: 'app-laboratorio-ordem-reparo-filtro',
  templateUrl: './laboratorio-ordem-reparo-filtro.component.html'
})
export class LaboratorioOrdemReparoFiltroComponent extends FilterBase implements OnInit, IFilterBase {
  ...
  constructor(
    ...
    super(_userService, _formBuilder, 'ordem-reparo');
  }
