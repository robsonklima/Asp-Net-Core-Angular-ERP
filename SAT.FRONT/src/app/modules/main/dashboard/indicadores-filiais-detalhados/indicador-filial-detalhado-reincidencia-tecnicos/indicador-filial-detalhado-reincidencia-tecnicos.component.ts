...
@Component({
  selector: 'app-indicador-filial-detalhado-reincidencia-tecnicos',
  templateUrl: './indicador-filial-detalhado-reincidencia-tecnicos.component.html'
})
export class IndicadorFilialDetalhadoReincidenciaTecnicosComponent implements OnInit {
