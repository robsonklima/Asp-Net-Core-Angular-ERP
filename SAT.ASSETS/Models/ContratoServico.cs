...
{
    [Table("ContratoServico")]
    [Index(nameof(CodServico), nameof(CodTipoEquip), nameof(CodGrupoEquip), nameof(CodEquip), nameof(CodSla), nameof(CodContrato), Name = "IX_ContratoServico", IsUnique = true)]
    public partial class ContratoServico
    {
        [Key]
