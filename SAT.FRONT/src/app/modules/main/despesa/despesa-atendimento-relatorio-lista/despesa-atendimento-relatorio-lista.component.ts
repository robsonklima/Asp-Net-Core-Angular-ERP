...
@Component({
  ...
  styles: [`
        .list-grid-despesa-atendimento-relatorio {
            grid-template-columns: 60px 72px 72px 70px auto 75px 80px 75px 80px 100px;
            @screen sm { grid-template-columns: 60px 72px 72px 70px auto 75px 80px 75px 80px 100px; }
            @screen md { grid-template-columns: 60px 72px 72px 70px auto 75px 80px 75px 80px 100px; }
            @screen lg { grid-template-columns: 60px 72px 72px 70px auto 75px 80px 75px 80px 100px; }
        }
    `],
