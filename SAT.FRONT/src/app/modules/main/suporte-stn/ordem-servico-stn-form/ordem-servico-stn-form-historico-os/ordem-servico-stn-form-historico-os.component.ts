...
@Component({
  selector: 'app-ordem-servico-stn-form-historico-os',
  templateUrl: './ordem-servico-stn-form-historico-os.component.html'
})
export class OrdemServicoStnFormHistoricoOsComponent implements OnInit
{
