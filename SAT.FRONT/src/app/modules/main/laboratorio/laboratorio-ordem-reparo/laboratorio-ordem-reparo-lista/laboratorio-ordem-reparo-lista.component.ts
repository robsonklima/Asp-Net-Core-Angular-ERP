  ...
  templateUrl: './laboratorio-ordem-reparo-lista.component.html',
	styles: [
		`.list-grid-ordem-reparo {
			grid-template-columns: 80px 196px 96px auto 104px 144px 86px;
...
export class LaboratorioOrdemReparoListaComponent implements AfterViewInit {
	...
	async obterDados(filtro: string = '') {
		...
		const data = await this._orService.obterPorParametros({
			...parametros
		}).toPromise();
