...
{
    [Table("PontoColaborador")]
    public partial class PontoColaborador
    {
        [Key]
        public int CodPontoColaborador { get; set; }
        [StringLength(20)]
