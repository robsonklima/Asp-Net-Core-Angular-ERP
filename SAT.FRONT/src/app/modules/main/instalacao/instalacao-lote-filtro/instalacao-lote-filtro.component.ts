...
@Component({
  selector: 'app-instalacao-lote-filtro',
  templateUrl: './instalacao-lote-filtro.component.html'
})
export class InstalacaoLoteFiltroComponent extends FilterBase implements OnInit, IFilterBase {
	...
	constructor(
		...
		super(_userService, _formBuilder, 'instalacao-lote');
	}
