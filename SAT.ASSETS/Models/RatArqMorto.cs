...
{
    [Table("RAT_ARQ_MORTO")]
    public partial class RatArqMorto
    {
        [Key]
        [Column("CodRAT")]
        ...
        public byte? IndRedeEstabilizada { get; set; }
        public byte? IndCedulaBoaQualidade { get; set; }
        public byte? IndCedulaVentilada { get; set; }
        public byte? IndInfraEstruturaLogicaAdequada { get; set; }
        [StringLength(10)]
