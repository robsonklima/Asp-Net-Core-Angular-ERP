...
{
    [Keyless]
    public partial class VwTarefasSlaDesenvolvimentoMonitoramento
    {
        public int OrdemMonitoramento { get; set; }
        [Column("numpriorizacaoOrdem")]
        public int NumpriorizacaoOrdem { get; set; }
        [Column("codTarefa")]
