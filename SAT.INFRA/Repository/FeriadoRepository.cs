...
namespace SAT.INFRA.Repository
{
    public class FeriadoRepository : IFeriadoRepository
    {
        ...
        public int CalculaDiasNaoUteis(DateTime dataInicio, DateTime dataFim, bool contabilizarSabado = false, bool contabilizarDomingo = false, int? codCidade = null)
        {
            ...
            Feriado[] feriadosSAT = _context.Feriado.Where(d => d.Data >= dataInicio && d.Data <= dataFim).ToArray();
