    ...
    public partial class InstalacaoRepository : IInstalacaoRepository
    {
        ...
        public Instalacao ObterPorCodigo(int codigo)
        {
            ...
            var data = _context.Instalacao
                ...
                .Include(i => i.LocalAtendimentoIns!.Autorizada)
                .Include(i => i.LocalAtendimentoIns!.Filial)
                .Include(i => i.LocalAtendimentoIns!.Regiao)
                .Include(i => i.LocalAtendimentoSol!.Autorizada)
                .Include(i => i.LocalAtendimentoSol!.Filial)
                .Include(i => i.LocalAtendimentoSol!.Regiao)
