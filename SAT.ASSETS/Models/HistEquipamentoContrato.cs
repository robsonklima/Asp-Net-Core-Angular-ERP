...
{
    [Table("HistEquipamentoContrato")]
    public partial class HistEquipamentoContrato
    {
        [Key]
        public int CodHistEquipContrato { get; set; }
        ...
        public int? DistanciaPatRes { get; set; }
        ...
        [StringLength(20)]
        public string ModeloEquip1 { get; set; }
        [StringLength(20)]
        public string ModeloEquip2 { get; set; }
        [StringLength(20)]
        public string ModeloEquip3 { get; set; }
        [StringLength(20)]
        public string ModeloEquip4 { get; set; }
        [StringLength(20)]
        public string ModeloEquip5 { get; set; }
        [Column("distancia_2_qatende")]
        [StringLength(50)]
        public string Distancia2Qatende { get; set; }
        [StringLength(20)]
        ...
        [Column(TypeName = "datetime")]
        public DateTime? DataHistEquipContrato { get; set; }
