...
{
    [Table("EquipamentoContrato")]
    public partial class EquipamentoContrato
    {
        public EquipamentoContrato()
        {
            Chamados = new HashSet<Chamado>();
            EquipamentoVipBkps = new HashSet<EquipamentoVipBkp>();
            Osatendida = new HashSet<Osatendida>();
            ParqueResumos = new HashSet<ParqueResumo>();
        ...
        [InverseProperty(nameof(Chamado.CodEquipContratoNavigation))]
        public virtual ICollection<Chamado> Chamados { get; set; }
        [InverseProperty(nameof(EquipamentoVipBkp.CodEquipContratoNavigation))]
        public virtual ICollection<EquipamentoVipBkp> EquipamentoVipBkps { get; set; }
        [InverseProperty("CodEquipContratoNavigation")]
        public virtual ICollection<Osatendida> Osatendida { get; set; }
        [InverseProperty(nameof(ParqueResumo.CodEquipContratoNavigation))]
        public virtual ICollection<ParqueResumo> ParqueResumos { get; set; }
        [InverseProperty(nameof(TecnicoEquipamento.CodEquipContratoNavigation))]
