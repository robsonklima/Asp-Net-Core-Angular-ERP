...
import { FuzeTag, FuzeTask } from 'app/core/types/fuze-task.types';
...
export class AnsListaComponent implements OnInit, OnDestroy {
  @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;
  drawerMode: 'side' | 'over';
  selectedTask: FuzeTask;
  tags: FuzeTag[];
  tasks: any[];
  tasksCount: any = {
    completed: 0,
  ...
  onBackdropClicked(): void {
    this._router.navigate(['ans'], { relativeTo: this._activatedRoute });

    this._changeDetectorRef.markForCheck();
  }

  createTask(): void {
      this._router.navigate(['/ans/form/',], { relativeTo: this._activatedRoute });
